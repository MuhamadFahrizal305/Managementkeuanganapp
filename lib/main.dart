...
import 'package:management_keuangan/screens/create_screen.dart';
import 'package:management_keuangan/screens/updata_screen.dart';
import 'package:management_keuangan/splash_screen.dart';
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.of(context)
                    ...
                    .then((value) {
                      setState(() {
                        // Refresh setelah kembali dari CreateScreen
                      });
                    });
              },
            ),
